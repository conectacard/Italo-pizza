...
const CONFIG = {
    ...
    youtubeUrl: "https://www.youtube.com/watch?v=zZ-eTjzqo28",
    textos: {
        cat1: { t: "QUIÉNES SOMOS", c: "Nacimos con una sola misión: ¡llevar las pizzas más deliciosas a tu mesa! Nos encanta consentirte con nuestra masa receta original e ingredientes frescos, y especialidades horneadas al momento. El lugar perfecto para compartir, reír y disfrutar de la mejor pizza." },
        cat2: { t: "ESTO NOS HACE DIFERENTES", c: "En nuestras sucursales servimos las pizzas hechas con recetas clásicas, postres deliciosos y bebidas bien frías. Además, contamos con servicio a domicilio para que disfrutes en casa, o puedes pedir directo en el mostrador para llevar." },
        cat3: { t: "CLIENTES FELICES", c: "Nuestros clientes, tanto locales como los que nos visitan de fuera, nunca dejan de saborear nuestro exquisito menú, reconociendo la tradición y la calidad de nuestras pizzas en cada una de nuestras sucursales." }
    },
    sucursales: {
...
function renderGallery(cat) {
    ...
    if (cat === 'cat3' || cat === 'cat2') {
        ...
        if (cat === 'cat3') {
            ...
            videoContainer.innerHTML = `
                <a href="https://www.youtube.com/shorts/_EBOrUneBz4" target="_blank" style="background: #b00; color: #fff; padding: 12px 25px; border-radius: 12px; text-decoration: none; font-weight: 900; font-size: 0.9rem;">
